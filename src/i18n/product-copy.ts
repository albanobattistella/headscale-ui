...
export const englishCopy = {
  ...
  orphanRefBannerTitle: "Policy references no longer match users",
  orphanRefBannerHintOne: "1 entry points to a user, team, or label that no longer exists.",
  orphanRefBannerHintMany: "{count} entries point to users, teams, or labels that no longer exist.",
  orphanReferenceBadge: "Stale reference",
  orphanReferenceTooltip:
    "We couldn't find a matching email or name in the user list — likely a typo, formatting difference, or the user was deleted. Click ✕ next to the entry to clean it up.",
...
const productCopyBase = {
  ...
  zh: {
    ...
    editNodeTagsDescription:
      "直接覆盖这台机器当前的标签值。要修改某类设备的访问权限，请到「访问控制」里编辑「设备标签 · 策略」。",
    nodeTags: "机器标签",
    ...
    tagDetailDialogTitle: "设备标签 · 策略",
    tagDetailDialogSubtitle:
      "定义谁拥有这个标签，以及哪些团队能访问带这个标签的设备。不会修改任何一台设备当前的标签值。",
    ...
    ipRulesSectionHint: "这些规则直接指向 IP/CIDR。建议给设备贴标签，这样换 IP 也不会丢权限。",
    ...
    orphanRefBannerTitle: "策略引用了不存在的用户/团队",
    orphanRefBannerHintOne: "有 1 处引用指向了不存在的用户、团队或标签。",
    orphanRefBannerHintMany: "有 {count} 处引用指向了不存在的用户、团队或标签。",
    orphanReferenceBadge: "引用已失效",
    orphanReferenceTooltip:
      "在用户列表中找不到匹配的邮箱或名称 —— 可能是写法不一致、格式差异，或该用户已被删除。可以点条目旁的 ✕ 直接清理。",
    cleanupOrphanRefsOne: "清理这 1 处引用",
    cleanupOrphanRefsMany: "清理这 {count} 处引用",
    cleanupOrphanRefsConfirm: "要清理全部失效引用吗？",
    cleanupOrphanRefsConfirmBody:
      "会一次性删除所有标记为「引用已失效」的条目。删完之后仍需要点页面顶部「保存」才能下发。",
    changesAutoSaveHint: "还需要点页面顶部「保存」按钮把改动下发到设备。",
    unsavedChangesBadge: "未保存",
    unsavedChangesTitle: "改动尚未保存",
    unsavedChangesBody: "改动现在只在浏览器里，没有下发到设备。确定关闭吗？",
  ...
  it: {
    ...
    dashboardSubtitle: "Una base di partenza per dispositivi, utenti e route private.",
    currentServer: "Server attuale",
    time: "Orario",
    hour: "Ora",
    minute: "Minuto",
    devicesTitle: "Macchine",
    membersTitle: "Utenti",
    memberDevices: "Dispositivi",
    invitesTitle: "Chiavi auth",
    routesTitle: "Rotte",
    accessTitle: "Controlli di accesso",
    ...
    errorUserStillOwns:
      "Questo utente possiede ancora macchine o chiavi di autenticazione. Rimuovile prima di continuare.",
    errorNodeNotFound: "Nodo non trovato.",
    errorRequestFailed: "Richiesta Headscale fallita. Controlla l'URL del server e la chiave API.",
